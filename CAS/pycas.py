...
#  Check pycas cookie
def get_cookie_status(environ):
	cookies = get_cookies(environ)
	return decode_cookie(cookies.get(PYCAS_NAME))


def get_ticket_status(cas_host,service_url,protocol,opt,environ):
...
#
def login(cas_host, service_url, environ, lifetime=None, secure=1, protocol=2, path="/", opt=""):
	...
	cookie_status, id = get_cookie_status(environ)
	...
	ticket_status, id = get_ticket_status(cas_host,service_url,protocol,opt,environ)
