...
\item Instructor Instructs MeetingTime (M:N)
\subitem This relationship is satisfied the inclusion of the Instructs table which has a MeetingTime id and an instructor id.
